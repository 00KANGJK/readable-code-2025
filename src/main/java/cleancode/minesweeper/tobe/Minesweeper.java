...
public class Minesweeper {
  ...
  private final ConsoleInputHadler consoleInputHandler = new ConsoleInputHadler();
  private final ConsoleOutputHadler consoleOutputHandler = new ConsoleOutputHadler();
